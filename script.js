document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Superman': [20, 12, 8, 6, 4, 3, 2, 0],
        'Batman': [16, 16, 11, 7, 5, 4, 2, 1],
        'Wonder Woman': [12, 12, 14, 9, 7, 5, 3, 2],
        'Thor': [10, 10, 11, 12, 8, 6, 4, 4],
        'Spider-Man': [8, 8, 8, 9, 11, 8, 5, 5],
        'Hulk': [6, 6, 7, 7, 8, 10, 7, 5],
        'Iron Man': [5, 5, 5, 6, 7, 9, 9, 7],
        'Black Panther': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Superman', year: '1938' },
        { city: 'Batman', year: '1939' },
        { city: 'Wonder Woman', year: '1941' },
        { city: 'Thor', year: '1962' },
        { city: 'Spider-Man', year: '1962' },
        { city: 'Hulk', year: '1962' },
        { city: 'Iron Man', year: '1963' },
        { city: 'Black Panther', year: '1966' }
    ];
